...
const randomImage = 'https://source.unsplash.com/1600x900/?nature,cars,photography'
      ...
      <div className='flex flex-col pb-5 '>
        <div className='relative flex flex-col mb-7'>
          <div className='flex flex-col justify-center items-center'>
            <img
              src={randomImage} alt="banner-pic"
          ...
          <div className='px-2'>
            {
              pins?.length > 0 ? <MasonryLayout pins={pins} /> : (
                <div className='flex justify-center items-center text-xl w-full mt-2'>
                  No Pins Found!!
                </div>
              )
            }
